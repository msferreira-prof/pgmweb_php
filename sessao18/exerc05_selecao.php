    ...
    <main class="container m-2 w-75 mx-auto my-font-family">
        ...
        <div class="row">
            <div class="col text-center m-0">
                <h2 class="mt-2 mb-5 my-h2">Exercício 05 - Seleção</h2>
            </div>
        </div>

        <!-- formulario HTML -->
        <form name="exerc06" action="exerc05.php" method="get" class="my-label-color-purple">

            <div class="form-group row">
                <label for="idTotalGanhos" class="col-sm-2 col-form-label">Total de Ganhos</label>
                <div class="col-sm-10">
                    <input class="form-control" type="text" id="idTotalGanhos" name="totalGanhos" placeholder="Informe o total de Ganhos" required>  
                </div>
            </div>
