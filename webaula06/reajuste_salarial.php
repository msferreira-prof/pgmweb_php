<?php
    ...
    // verifica se o cookie "nome_usuario" existe na variavel global $_COOKIE
    // esta variavel contem todos os cookies, e ainda disponiveis, criados pela aplicacao 
    if (isset($_COOKIE['nome_usuario'])) {
        $nomeUsuario = $_COOKIE['nome_usuario'];
    }
    
    /* ou
    $nomeUsuario = isset($_COOKIE['nome_usuario']) ? $_COOKIE['nome_usuario'] : null;
    */
